...
Report 5266401 "lbt Sales Template"
{
	...
	dataset
	{
		dataitem(Header;"Sales Invoice Header")
		{
			...
			dataitem(Line;"Sales Invoice Line")
			{
				...
				DataItemTableView = sorting("Document No.", "Line No.") order(Descending);
	...
	rendering
	{
		layout(FORNAV)
		{
			Type = Custom;
			MimeType = 'FORNAV';
			LayoutFile = '.\Layouts\lbtSalesTemplate.docx';
		}
	}
	labels
	{
		label(Alternative;ENU='Alternative',
			DEU='Alternativ')
		label(Optional;ENU='Optional',
			DEU='Bedarf')
	}
