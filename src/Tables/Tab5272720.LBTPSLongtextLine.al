table 5272720 "LBT PS Longtext Line"
{
    ...
    var
        SplitString: DotNet String;
        NewString: DotNet String;
        SplitArray: DotNet Array;
        DelimiterArray: DotNet Array;
        TrimArray: DotNet Array;
        i: Integer;
        Char: Char;
        ende: Boolean;
        newstring1: Text;
