table 5272725 "LBT Report - Attribute Setup"
{
    ...
    var
        Text5272725: Label 'In this Report-Type is no Report-ID allowed.';
        Text5272724: Label 'Position 0 is not allowed!.';
        Text5272723: Label 'Typing is not correct. A correct entry would be for example\\1      A minimum of 1 and a maximum of 1 decimal place\1:4   A minimum of 1 and a maximum of 4 decimal places\2:     At least 2 decimal places\:2     No more than 2 decimal places.';
        Text5272722: Label 'Decimal places only valid for parameters with decimal type.';
        Text5272728: Label '%1 are not part of your solution.';
