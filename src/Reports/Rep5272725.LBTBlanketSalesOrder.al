report 5272725 "LBT Blanket Sales Order"
{
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocumentConfirmCopyCaption; STRSUBSTNO(Text004, CopyText))
                    {
                    }
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    {
                        Caption = 'Hide Company Info', Comment = 'DEU="Aktivität protokollieren"';
                    }
    ...
    var
        Text004: Label 'Blanket Sales Order %1', Comment = 'DEU="Rahmenauftragsnr. %1"';
        ...
        Line_DimensionsCaption_Control174Lbl: Label 'Line Dimensions', Comment = 'DEU="Zeilendimensionen"';
        ...
        PrepmtVATAmountLine__VAT_Base__Control208CaptionLbl: Label 'Total', Comment = 'DEU="Gesamt"';
        ...
        DocCaptionLbl: Label 'Blanket Sales Order %1', Comment = 'DEU="Rahmenauftragsnr. %1"';
    ...
    begin
        LeBitReportFunctions.GetSourceType(TypeVar::Sales, ReportType::"Blanket Sales Order", CustSource);
    end;
}
